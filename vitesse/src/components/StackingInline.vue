...
<template>
  <h2 class="border-2 border-b-0 border-black dark:border-gray-400 inline-block bottom-(-2) p-2 mt-4 relative">
    Merge NFTs
  </h2>
  <div class="md:flex justify-items-center border-2 border-black dark:border-gray-400 p-4">
    <div class="md:mr-12">
      <div>
        Top:
      </div>
      ...
      <div class="relative">
        <OnClickOutside @trigger="isVisible1 = false">
          <div class="btn secondary w-50 h-15 cursor-pointer flex p-0" @click="isVisible1 = !isVisible1">
            <img v-if="token1" class="w-14 h-14 border-4 border-white dark:border-gray-900" alt="Dots" :src="token1.image">
    ...
    <div class="md:mr-12 self-end pt-4">
